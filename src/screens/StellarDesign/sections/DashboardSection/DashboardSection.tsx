    ...
    <section className="relative w-full bg-gradient-to-b from-white via-red-50/5 to-white py-16 lg:py-24 px-4 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12 lg:mb-16 z-10 relative">
          <div className="[font-family:'Inter',Helvetica] font-semibold text-rose-500 text-sm lg:text-base tracking-wide uppercase mb-6 lg:mb-8 drop-shadow-sm">
          ...
          <div className="space-y-2">
            ...
            <div className="[font-family:'Inter',Helvetica] font-bold text-3xl lg:text-5xl tracking-tight leading-tight">
              <span className="bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">with </span>
              <span className="text-transparent bg-gradient-to-r from-rose-500 to-pink-600 bg-clip-text drop-shadow-sm">
                our Integrations
              </span>
            </div>
          </div>
        ...
        <div className="flex justify-center mb-12 lg:mb-16 z-10 relative">
          <img
            className="w-full max-w-[800px] h-auto object-contain rounded-[2.5rem] shadow-2xl border border-white/30 hover:scale-105 transition-transform duration-500"
        ...
        <div className="max-w-[700px] mx-auto text-center px-4 z-10 relative">
          <p className="[font-family:'Inter',Helvetica] font-normal text-gray-600 text-lg lg:text-xl leading-relaxed bg-white/75 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-white/60 drop-shadow-sm hover:bg-white/80 transition-all duration-300">
