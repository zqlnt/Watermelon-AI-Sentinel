  ...
  return (
    <section className="relative w-full bg-gradient-to-b from-white via-green-50/5 to-white py-16 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-40 right-20 w-60 h-60 lg:w-120 lg:h-120 bg-gradient-to-br from-green-200 to-emerald-300 rounded-full blur-3xl opacity-1 animate-pulse" style={{ animationDelay: '1.5s' }}></div>
        <div className="absolute bottom-40 left-20 w-52 h-52 lg:w-104 lg:h-104 bg-gradient-to-br from-red-200 to-pink-300 rounded-full blur-3xl opacity-1 animate-pulse" style={{ animationDelay: '3.5s' }}></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-16 items-center">
          <div className="lg:col-span-2 space-y-8 z-10 relative">
            <header className="space-y-6">
              <div className="[font-family:'Inter',Helvetica] font-semibold text-green-600 text-sm lg:text-base tracking-wide uppercase text-center lg:text-left">
                Our Key Features
              </div>
              <h2 className="[font-family:'Inter',Helvetica] font-bold text-gray-900 text-3xl lg:text-5xl tracking-tight leading-tight max-w-[550px] text-center lg:text-left mx-auto lg:mx-0">
          ...
          <div className="lg:col-span-3 z-10 relative">
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
              {features.map((feature, index) => (
                <Card
                  key={index}
                  className="border-none shadow-lg bg-white/70 backdrop-blur-sm rounded-2xl p-6 hover:shadow-xl transition-all duration-300 hover:bg-white/80 hover:scale-105"
                >
                  <CardContent className="p-0 space-y-4 text-center lg:text-left">
                    <img
                      className="w-12 h-12 flex-shrink-0 mx-auto lg:mx-0 rounded-xl shadow-md"
                      alt="Feature icon"
                      src={feature.icon}
                    />
